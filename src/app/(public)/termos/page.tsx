  ...
  return (
    <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-10 sm:py-14">
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-zinc-700">
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-zinc-900">2. Idade mínima (18+)</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-zinc-900">4. Conduta</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-zinc-900">5. Matches e contatos</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-semibold text-zinc-900">6. Ingressos e pagamento</h2>
          <p>
            A compra de ingresso está sujeita à disponibilidade de vagas por
            gênero e às regras de{" "}
            <Link
              href="/reembolso"
